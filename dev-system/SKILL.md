...
| **Group**        | One feature of the active scope, described end-to-end. The unit that has to work when its last task lands. Group 1 is the foundation — the fifth of the scope that fixes what every later group binds to.   | A feature    |
