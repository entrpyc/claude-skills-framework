...
4. **Wipe the scope.** Delete everything in `docs/scope/`. Only after steps 1 to 3 are done — this is the last moment the plan exists. **Leave `docs/design-references/` alone**; it belongs to the operator and spans scopes.
